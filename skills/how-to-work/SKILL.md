...
`how-to-work` is the canonical skill name. Invoke `/how-to-work` or `/how-to` when you want the full workflow. The old `how-we-work` name is a compatibility alias only; do not choose it for new installs, docs, or prompts.
